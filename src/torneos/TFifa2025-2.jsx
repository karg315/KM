...
export default function TFifa20252() {
    ...
    const obtenerPartidosFaseEliminatoria = async (
        ...
        let partidosQuery = collection(db, "partidosFinales20252");
    ...
    return (
        <div className="Torneo-Fifa">
            <Navbar />
            <h2>Torneo FIFA Kartel de las Moritaz 2025-2</h2>
